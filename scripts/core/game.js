...
(function () {
    ...
    var assetManifest = [
        ...
        { id: "playBackground", src: imagePath + "background.jpg" },
        ...
        { id: "winSound", src: soundPath + "win.wav" },
    ...
    function Start() {
        console.log("%c Yayy..Game Started...", "color: blue; font-size: 20px;");
        canvas = document.getElementsByTagName("canvas")[0];
        managers.Game.playerBet = document.getElementsByTagName("input")[0];
        stage = new createjs.Stage(canvas);
        managers.Game.stage = stage;
        stage.enableMouseOver(20);
        createjs.Ticker.framerate = 80; // game will run at 80fps
